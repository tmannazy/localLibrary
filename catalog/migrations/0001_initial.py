    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text="13 Character <a href='https://www.isbn-international.org/content/what-isbn'>ISBN</a>", max_length=13, unique=True, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('ad216342-1d09-4637-a47d-72c8f09c4077'), help_text='Unique ID for this particular book across whole library', primary_key=True, serialize=False)),
