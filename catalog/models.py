...
class Book(models.Model):
	...
	isbn = models.CharField('ISBN', max_length=13, unique=True, help_text="13 Character "
	                                                                      "<a href='https://www.isbn-international.org/content/what-isbn'>ISBN</a>")
	...
	display_genre.short_description = 'Book Genre'
...
class Language(models.Model):
	...
	name = models.CharField(max_length=200,
	                        help_text="Enter the book's natural language (e.g. English, French, Igbo etc.)")
